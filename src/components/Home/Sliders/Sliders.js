...
const Sliders = () => {
     return (
          <div className="headersBgColor container-fluid">
              <div className="row py-5 align-items-center justify-content-around text-white">
                <div className="col-md-5">
                  ...
                  <h1 className="fw-bold mb-4 mt-4 comfortableCar">Enjoy your journey with our comfortable cars.</h1>
                  <p className="honda-cbr-detail mb-3 getAnExtra">Honda Car is currently the best of all car with a very good quality service. So buy without delay. This Car has a lot of features and let's buy it in our stock much less quickly and Explore your car and buy the one you like</p>
                ...
                <div className="col-md-5 mt-lg-0 mt-md-0 mt-5">
                  <img src="https://i.ibb.co/fFzWgR9/finalllll-removebg-preview.png" className="img-fluid" alt="Car Image"/>
                </div>
              </div>
          </div>
     )
